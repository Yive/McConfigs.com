...
<title>McConfig - Essentials Generator</title>
<div class="container">
   <header class="page-header">
      <h1>Essentials:</h1>
   </header>
   <form class="form" action="./output" method="POST">
      <input type="hidden" name="plugin-name" value="Essentials">
